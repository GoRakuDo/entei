...
**残りのdelivery gate:** HTTPSでdeployされたEntei origin、growing media、audio listening/decode、Windows x64 installer。Stage B（Android / Termux clean install）とrelease identity表示修正の実機検証（rc.3）は通過済み。
