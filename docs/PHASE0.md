...
| ------------------------------------ | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ |
| Confirmed                            | Hosting / deploy先         | **GitHub Pages**（custom domain `entei.gorakudo.org`）。main ブランチへの push で GitHub Actions（`.github/workflows/deploy.yml`）が自動デプロイ（2026-08-12 導入・初回デプロイ済み）。                                                                                                                                   | Unit 0.1前 → 解決済            |
