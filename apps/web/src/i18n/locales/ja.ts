...
export const ja: Dictionary = {
  ...
  playerUI: {
    ...
    contextQuotaExceeded: 'Nadeshikoの使用量をご確認ください',
  ...
  audioPlayer: {
    ...
    skipForward30: '30秒進む',
    playbackSpeed: '再生速度',
    unsupportedFile: 'サポートされている音声ファイルを選択してください。',
    playbackError: 'この音声ファイルを再生できません。',
    audioElement: '音声再生',
    defaultTitle: '音声トラック',
    noTrack: '音声ファイルを選択して聴き始めてください。',
    acceptedFormats: '対応形式: MP3、WAV、FLAC、AAC、M4A、M4B、OPUS。',
    displayMode: '音声表示モード',
  },
  profile: {
    title: 'デバイスプロフィール',
    localOnlyBadge: 'この端末のみ',
    tabsLabel: 'プロフィールのセクション',
    immersionStats: 'イマージョン統計',
    ...
    editProfileShort: '編集',
    bioLabel: '自己紹介',
    bioCount: (count: number) => `${count}/360文字`,
    changeAvatar: 'プロフィール画像を変更',
    avatarAlt: 'プロフィール画像',
    avatarUploadTooLarge: '画像が大きすぎます。小さい画像を選んでください（最大200KB）。',
