...
export const ja: Dictionary = {
  ...
  playerUI: {
    ...
    ytModeSpeedDesc: 'プログレッシブ形式（360p〜1080p）を優先し、DL中から再生。',
    ...
    contextKeyMissing: 'Nadeshiko API キーが未設定です',
    contextKeyMissingAction: '設定を開く',
    contextInvalidKey: 'API キーが無効です。設定で更新してください',
    contextRateLimited: (seconds: number) => `レートリミットに達します。${seconds}秒後に再試行してください`,
