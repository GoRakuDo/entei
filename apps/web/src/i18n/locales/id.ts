...
export const id: Dictionary = {
  ...
  playerUI: {
    ...
    contextKeyMissing: 'Kunci API Nadeshiko belum diatur',
    contextKeyMissingAction: 'Buka pengaturan',
    contextInvalidKey: 'Kunci API tidak valid. Perbarui di pengaturan',
    contextRateLimited: (seconds: number) => `Batas tercapai. Coba lagi dalam ${seconds} detik`,
