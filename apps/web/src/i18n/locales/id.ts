...
export const id: Dictionary = {
  ...
  playerUI: {
    ...
    companionJobFailed: 'Unduhan gagal. Silakan coba URL baru atau pilih file.',
    ...
    jimakuShow: 'Tampilkan',
    jimakuHide: 'Sembunyikan',
    jimakuClear: 'Hapus',
    ...
    contextTabLabel: 'Konteks',
    contextSearchPlaceholder: 'Masukkan kata atau kalimat',
    contextSearchButton: 'Cari',
    contextSearchAriaLabel: 'Cari konteks di Nadeshiko',
    contextEmpty: 'Tidak ada contoh yang ditemukan',
    contextKeyMissing: 'Masukkan kunci API Nadeshiko',
    contextKeyInputPlaceholder: 'Masukkan kunci API',
    contextKeySave: 'Simpan',
    contextKeySaveFailed: 'Gagal menyimpan. Coba lagi.',
    ...
    contextQuotaExceeded: 'Periksa penggunaan Nadeshiko Anda',
    contextNetworkError: 'Tidak dapat menghubungi Nadeshiko',
    contextGenericError: 'Terjadi kesalahan saat mencari',
    contextContextLoading: 'Memuat konteks sekitar…',
    contextContextFailed: 'Tidak dapat memuat konteks sekitar',
    ...
    subtitleSyncButtonLabel: 'Sinkron Subtitle',
    subtitleSyncSuccess: 'Sinkronisasi subtitle berhasil!',
    subtitleSyncNoReference:
      'Tidak ada subtitle dasar di video ini, tidak dapat disinkronkan',
  ...
  audioPlayer: {
    ...
    play: 'Putar',
    pause: 'Jeda',
    seek: 'Cari posisi audio',
    skipBack10: 'Mundur 10 detik',
    skipBack30: 'Mundur 30 detik',
    skipForward10: 'Maju 10 detik',
    skipForward30: 'Maju 30 detik',
    playbackSpeed: 'Kecepatan pemutaran',
    unsupportedFile: 'Pilih file audio yang didukung.',
    playbackError: 'File audio ini tidak dapat diputar.',
    audioElement: 'Pemutaran audio',
    defaultTitle: 'Trek audio',
    noTrack: 'Pilih file audio untuk mulai mendengarkan.',
    acceptedFormats: 'Format yang diterima: MP3, WAV, FLAC, AAC, M4A, M4B, dan OPUS.',
    displayMode: 'Mode tampilan audio',
  },
  profile: {
    title: 'Profil perangkat',
    localOnlyBadge: 'Hanya lokal',
    tabsLabel: 'Bagian profil',
    immersionStats: 'Statistik imersi',
    contentHistory: 'Riwayat konten',
    nameLabel: 'Nama',
    saveProfile: 'Simpan profil',
    closeEdit: 'Tutup editor',
    editProfileShort: 'Ubah',
    bioLabel: 'Bio',
    bioCount: (count: number) => `${count}/360 karakter`,
    changeAvatar: 'Ubah gambar profil',
    avatarAlt: 'Gambar profil',
    avatarUploadTooLarge: 'Gambar terlalu besar. Pilih gambar yang lebih kecil (maksimal 200 KB).',
  ...
  trackerDashboard: {
    ...
    controlsHeading: 'Kontrol pelacak',
    historyHeading: 'Riwayat tambang',
