...
export const en: Dictionary = {
  ...
  playerUI: {
    ...
    subtitleSyncButtonLabel: 'Subtitle Sync',
  ...
  profile: {
    ...
    immersionStats: 'Immersion stats',
    contentHistory: 'Content history',
    nameLabel: 'Name',
    nameHelp: 'This name is stored on this device only.',
    rerollName: 'Roll a new name',
    saveName: 'Save name',
    saveProfile: 'Save profile',
    closeEdit: 'Close editor',
    editProfile: 'Edit profile',
    bioLabel: 'Bio',
    bioCount: (count: number) => `${count}/360 characters`,
    changeAvatar: 'Change profile image',
    avatarAlt: 'Profile image',
    avatarUploadTooLarge: 'That image is too large. Choose a smaller image (200 KB maximum).',
  ...
  trackerDashboard: {
    ...
    controlsHeading: 'Tracker control',
    historyHeading: 'Mining history',
